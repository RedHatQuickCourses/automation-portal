...
For more Information on the Automation Portal or for RBAC hands on lab, refer to the https://catalog.demo.redhat.com/catalog/all?search=automation+portal&item=babylon-catalog-prod%2Fagd-v2.aap-multiinstance-workshop.prod[Introduction to AAP Self-Service Automation]
